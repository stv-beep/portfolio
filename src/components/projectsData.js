...
export const projects = [
    ...
    },
    {
        ...
        text: 'Work hours registration application. Different shifts during the day and different tasks, each one with its registration. In addition, an administration and consultation area. Currently used in a company. There is no demo at the moment.',
    ...
    },
    {
        ...
        text: `An app that beautifies and enhances the user's input (using AI) as if it had been written by someone extremely cultured. For example: "I like the chocolate." can be "I am fond of the confectionery known as chocolate."`,
        buttonText: 'Source code',
